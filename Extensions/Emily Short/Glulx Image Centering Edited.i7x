Version 2 of Glulx Image Centering edited (for Glulx only) by Emily Short begins here.
...
to display (chosen text - an indexed text) inline:
	(- DrawInline({chosen text}); -)
	
to display (chosen text - an indexed text) centered:
	say first custom style; say " ";
	display chosen text inline;
	say " [line break]"; 
	say roman type; 
...
Glulx Image Centering edited ends here.
