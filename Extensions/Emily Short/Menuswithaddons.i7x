Version 1 of Menuswithaddons by Emily Short begins here.
...
The Currentmenufigure is a figure that varies. the current menu figure is figure 1.

Table of Sample Options
title	subtable	description	toggle
"ak"	a table-name	"bar"	a rule
